    ...
    <div class="active-ride-container">
        ...
        <div class="car-info">
            ...
            <div class="car-details">
                <h3>${car.getManufacturerName()} ${car.getModel()}</h3>
                <p>ID: ${car.getId()}</p>
            </div>
        </div>
        ...
        <div class="cost-section pulse-animation">
            ...
            <div class="cost-details">Rate: <%=carPrice%> BAM/second</div>
        </div>

        <div class="action-buttons">
            <form id="endRideForm" action="Controller" method="POST" style="display: inline;">
                <input type="hidden" name="action" value="endCarRide">
